UML Plugin for Eclipse                                   December 10 2007
by Omondo                                                http://www.omondo.com
------------------------------------------------------------------------------

Abstract
-----------
Omondo UML Plugin for Eclipse is a plugin for UML modeling in Eclipse 3.3 It
can be used both for creating new models and for reverse engineering existing models.

This is a beta release of EclipseUML 2007 Europa Free Edition for Eclipse 3.3 3.3.0.v20071210 with full class diagram, sequence diagram,
...
System Requirements
----------------------
This version of the program has been qualified for Eclipse 3.3 running on Windows 2000/XP/Vista environment.
It can be downloaded at http://www.eclipse.org/

The GEF (Graphical Editor Framework) plugin is required (build GEF-ALL-3.3.1).
It is provided by Omondo through the EclipseUML zip file or auto-installer.

The EMF (Eclipse Modeling Framework) plugin is required (build emf-sdo-xsd-SDK-2.3.1).
It can be downloaded at http://www.eclipse.org/emf.

The UML2 plugin is required (build mdt-uml2-SDK-M200708301304).
